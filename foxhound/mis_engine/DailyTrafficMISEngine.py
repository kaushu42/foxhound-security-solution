...
class DailyTrafficMISEngine(object):
    ...
    def _extract_mis_daily(self):
        GROUPING_COLUMNS = ['processed_datetime', 'logged_datetime', 'firewall_rule_id',
        ...
        self._write_df_to_postgres(
            grouped_agg, "fh_stg_trfc_mis_dy_a", "append")
    ...
    def _extract_mis_new_source_address(self):
        ...
        grouped_agg = grouped_agg.select(*COLUMN_HEADERS)
        self._write_df_to_postgres(
            grouped_agg, "fh_stg_trfc_mis_new_src_ip_dy_a", "append")
    ...
    def _extract_mis_new_destination_address(self):
        ...
        grouped_agg = grouped_agg.select(*COLUMN_HEADERS)
        self._write_df_to_postgres(
            grouped_agg, "fh_stg_trfc_mis_new_dst_ip_dy_a", "append")
    ...
    def _extract_mis_new_application(self):
        ...
        grouped_agg = grouped_agg.select(*COLUMN_HEADERS)
        self._write_df_to_postgres(
            grouped_agg, "fh_stg_trfc_mis_new_app_dy_a", "append")
    ...
    def _extract_mis_requests_from_blacklisted_ip_event(self):
        ...
        grouped_agg = grouped_agg.select(*COLUMN_HEADERS)
        self._write_df_to_postgres(
            grouped_agg, "fh_stg_trfc_mis_req_frm_blip_dy_a", "append")
    ...
    def _extract_mis_responses_to_blacklisted_ip_event(self):
        ...
        grouped_agg = grouped_agg.select(*COLUMN_HEADERS)
        self._write_df_to_postgres(
            grouped_agg, "fh_stg_trfc_mis_res_to_blip_dy_a", "append")
