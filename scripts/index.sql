...
create index idx_fh_prd_trfc_mis_req_frm_blip_dy_a_frwl_rule ON fh_prd_trfc_mis_req_frm_blip_dy_a(firewall_rule_id);
create index idx_fh_prd_trfc_mis_req_frm_blip_dy_a_frwl_rule_lgdt ON fh_prd_trfc_mis_req_frm_blip_dy_a(firewall_rule_id, logged_datetime);
...
create index idx_fh_prd_trfc_mis_res_to_blip_dy_a_frwl_rule ON fh_prd_trfc_mis_res_to_blip_dy_a(firewall_rule_id);
create index idx_fh_prd_trfc_mis_res_to_blip_dy_a_frwl_rule_lgdt ON fh_prd_trfc_mis_res_to_blip_dy_a(firewall_rule_id, logged_datetime);
