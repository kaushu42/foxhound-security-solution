...
const FETCH_API = `${ROOT_URL}dashboard/top/destination-address/`;
...
class TopDestinationAddressChart extends Component {
    ...
    updateChart = () => {
        ...
        switch(this.state.basis){
            case "bytes_received":
                title = "Top Destination Address | Bytes Received";
