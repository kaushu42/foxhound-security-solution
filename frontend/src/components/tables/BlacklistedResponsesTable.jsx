...
const FETCH_BLACKLIST_DESTINATION_API = `${ROOT_URL}mis/blacklist/responses/`;

class BlacklistedResponsesTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: [
  ...
  fetchProcessedLogsFromDb = (params = {}) => {
    ...
    reqwest({
      url: FETCH_BLACKLIST_DESTINATION_API,
      method: "get",
      headers: {
...
export default connect(mapStateToProps, null)(BlacklistedResponsesTable);
