...
class AnomalousRulesTable extends Component {
    ...
    downloadExcel = () => {
        const data = this.props.anomalousRulesData ? this.props.anomalousRulesData : '';//tabular data
         var option={};
         let dataTable = [];
         if (data) {
            console.log(data);
           for (let i in data) {
             if(data){
               let obj = {
                            ...
                            'Flagged by':data[i].verified_by_user.username
               }
               dataTable.push(obj);
             }
           }
         }
            option.fileName = 'Anomalous Rule'
         option.datas=[
           {
             sheetData:dataTable,
             sheetName:'sheet',
                    sheetFilter:['Created datetime','Source address','Source address alias','Destination address','Destination address alias','Application','Firewall rule','Flagged date', 'Flagged by'],
                    sheetHeader:['Created Datetime','Source address','Source address alias','Destination address','Destination address alias','Application','Firewall rule','Flagged date', 'Flagged by']
           }
         ];
