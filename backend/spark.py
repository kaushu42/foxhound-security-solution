...
#             Spark()
#         Spark.__sparkSession = SparkSession.builder.master(SPARK_MASTER_URL).appName(
#             "foxhound").config('spark.cassandra.connection.host', ','.join(CASSANDRA_NODES)).getOrCreate()
